...
class comfyRemote_UI(QtWidgets.QMainWindow):
    ...
    def __init__ (self, parent=None):
        ...
        UI_path = os.path.join(dirname, 'remoteUI_v001.ui')
        ...
        styleSheet_file = QtCore.QFile(os.path.join(dirname, 'styleSheet01.qss'))
        ...
        # icons:
        self.setWindowIcon(QtGui.QIcon(os.path.join(dirname,'remoteUI_icon.png')))
    ...
    def get_latest_versioned_file(directory, extension):
        # need to implement to be sure we are using the latest and greatest for : UI / QSS/ ICON
        pass
    ...
    def fill_rootParameters(self):
        ...
        data = [
            ('Batch Size', '1', 'Number of times the template run'),
            ('Frame Range', '1001-1100', 'Need to match input - Empty will run full frame range'),
        ]
        # Populate the table
    ...
    def export_table(self):
        """
        Function to export the current tableView data and run command.
        """
        ...
        rootParameters = {"Batch Size": '', "Frame Range": ''}
        ...
        # example line for command:
        #dncomfyui -r --json_file script_files/fileout_test.json --batch_size 1 --str_args '{"Image_path": "/u/gdso/Pictures/syndata_test/imgs/images_1.png"}' --int_args '{"Steps": 50, "Seed": 432134}' --float_args '{"cnStrength": 0.8}'
        '''
